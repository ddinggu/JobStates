...
export const getVapiedKey = () =>
  axios.get(`${URL}/push/vapidkey`, TokenHeader);

export const postSubscription = subscription =>
  axios.post(`${URL}/push/send`, { subscription }, TokenHeader);

export const deleteSubscription = () =>
  axios.delete(`${URL}/push/subscription`, TokenHeader);

// Analysis
export const getUserAnalysisData = () =>
  axios.get(`${URL}/analytics`, TokenHeader);
...
export const authenticateUser = () =>
  axios.get(`${URL}/auth/check`, TokenHeader);
